...
The information will keep updating as the technology is still evolving. If you spot something that you believe is outdate, or simply something that will add value please open an issue!
...
| [Move Literature](./move_literature/) | If you're looking to learn more about Move and understand Move code / VM better |
| [Move Tooling](./move_tooling/) | Here you can find tools to help you with your craft |
...
| [Protocol Deep Dives](./protocols_deep_dives/) | If you wish to learn more about important Move protocols in the space |
| [Security Best Practices](./security_best_practices/) | For specific Move "gotchas" |
| [Specific Move Vulnerabilities](./specific_move_vulnerabilities/README.md) | To learn for already found bugs |
...
| [Education](./educational_content/) | Anything that did not fit exactly with the above goes here |

## Connect
I am available for any questions and help with your Move journey!
